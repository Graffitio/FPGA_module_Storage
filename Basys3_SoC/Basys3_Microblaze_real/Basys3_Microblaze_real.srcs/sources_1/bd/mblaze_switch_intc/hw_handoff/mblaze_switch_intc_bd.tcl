...
################################################################
# This is a generated script based on design: mblaze_switch_intc
#
...
# source mblaze_switch_intc_script.tcl
...
set design_name mblaze_switch_intc
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports dip_switches_16bits] [get_bd_intf_pins axi_gpio_switch/GPIO]
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_switch_ip2intc_irpt [get_bd_pins axi_gpio_switch/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In0]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_switch/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_switch/S_AXI/Reg] -force
