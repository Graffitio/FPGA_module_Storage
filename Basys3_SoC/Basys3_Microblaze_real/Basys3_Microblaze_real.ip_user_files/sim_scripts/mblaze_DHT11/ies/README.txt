...
#
# Generated by export_simulation on Wed Nov 22 15:28:50 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './mblaze_DHT11.sh' script.

./mblaze_DHT11.sh -reset_run
...
./mblaze_DHT11.sh -noclean_files

For more information on the script, please type './mblaze_DHT11.sh -help'.
