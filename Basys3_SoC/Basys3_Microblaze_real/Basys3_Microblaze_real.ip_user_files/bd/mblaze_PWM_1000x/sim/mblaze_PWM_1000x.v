...
//Date        : Tue Nov 21 15:51:36 2023
//Host        : DESKTOP-CPLDPO1 running 64-bit major release  (build 9200)
//Command     : generate_target mblaze_PWM_1000x.bd
//Design      : mblaze_PWM_1000x
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module m00_couplers_imp_OHIU1Y
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_1H3IB01
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
(* CORE_GENERATION_INFO = "mblaze_PWM_1000x,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mblaze_PWM_1000x,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_mb_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "mblaze_PWM_1000x.hwdef" *) 
module mblaze_PWM_1000x
   (pwm_1000pc_0,
    reset,
    sys_clock,
    usb_uart_rxd,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN mblaze_PWM_1000x_sys_clock, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input sys_clock;
  ...
  wire myip_PWM_1000x_0_pwm_1000pc;
  wire reset_1;
  ...
  assign pwm_1000pc_0 = myip_PWM_1000x_0_pwm_1000pc;
  assign reset_1 = reset;
  assign sys_clock_1 = sys_clock;
  assign usb_uart_txd = axi_uartlite_0_UART_TxD;
  mblaze_PWM_1000x_axi_uartlite_0_0 axi_uartlite_0
  ...
  mblaze_PWM_1000x_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock_1),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_0_locked),
        .reset(reset_1));
  mblaze_PWM_1000x_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > mblaze_PWM_1000x microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  mblaze_PWM_1000x_microblaze_0_0 microblaze_0
  ...
  mblaze_PWM_1000x_microblaze_0_axi_periph_0 microblaze_0_axi_periph
  ...
  microblaze_0_local_memory_imp_K9UX28 microblaze_0_local_memory
  ...
  mblaze_PWM_1000x_myip_PWM_1000x_0_0 myip_PWM_1000x_0
       (.pwm_1000pc(myip_PWM_1000x_0_pwm_1000pc),
  ...
  mblaze_PWM_1000x_rst_clk_wiz_0_100M_0 rst_clk_wiz_0_100M
       (.aux_reset_in(1'b1),
...
module mblaze_PWM_1000x_microblaze_0_axi_periph_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_OHIU1Y m00_couplers
  ...
  m01_couplers_imp_1H3IB01 m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_KTMU34 s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module microblaze_0_local_memory_imp_K9UX28
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > mblaze_PWM_1000x microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  mblaze_PWM_1000x_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  mblaze_PWM_1000x_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  mblaze_PWM_1000x_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  mblaze_PWM_1000x_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  mblaze_PWM_1000x_lmb_bram_0 lmb_bram
...
module s00_couplers_imp_KTMU34
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
