...
HD_PWD='F:/Ian_Jung/workplace/cora_z7/cora_cpu_2019/basys3_SoC/basys3_SoC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FND_4digit_cntr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FND_4digit_cntr.tcl
