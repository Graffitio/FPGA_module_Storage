...
HD_PWD='F:/Ian_Jung/workplace/cora_z7/cora_cpu_2019/basys3_SoC/basys3_SoC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FND_4digit_cntr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FND_4digit_cntr.tcl -notrace
